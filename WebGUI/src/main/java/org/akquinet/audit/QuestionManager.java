...
public class QuestionManager
{
	...
	public void triggerActions(HttpServletRequest request)
	{
		...
		if (action != null)
		{
			...
			{
				String answer = request.getParameter(CommonData.PARAM_ANSWER);
				try
				{
	...
	{
		String apacheExec = request.getParameter(CommonData.PARAM_APACHE_EXECUTABLE);
		if (apacheExec == null)
		{
		...
		String apacheConf = request.getParameter(CommonData.PARAM_APACHE_CONFIG);
		if (apacheConf == null)
		{
		...
		boolean highSec = request.getParameter(CommonData.PARAM_HIGH_SECURITY) != null;
		boolean highPriv = request.getParameter(CommonData.PARAM_HIGH_PRIVACY) != null;
